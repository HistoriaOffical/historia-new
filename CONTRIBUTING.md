...
[good first issue](https://github.com/historia/historia/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
[Translation Process](https://github.com/historia/historia/blob/master/doc/translation_process.md)
...
The review process is normally fairly responsive on the Historia Core repository, however
...
Bitcoin Backports are an incredibly valuable part of Historia's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for Historia](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
