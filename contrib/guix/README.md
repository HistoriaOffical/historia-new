# Bootstrappable Historia Core Builds

This directory contains the files necessary to perform bootstrappable Historia
Core builds.
...
To build Historia Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Historia Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/historia-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/historia/guix.sigs).
...
[guix-docker]: https://github.com/historia/historia/tree/master/contrib/guix/Dockerfile
