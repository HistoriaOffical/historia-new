...
"""Verify that starting historiad with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start historiad with -h for help text")
        ...
        self.log.info("Start historiad with -version for version information")
        ...
        self.log.info("Start historiadd with -fakearg to make sure it does not start")
