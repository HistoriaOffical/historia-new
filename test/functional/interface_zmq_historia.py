...
"""Test the historia specific ZMQ notification interfaces."""
...
class HistoriaZMQTest (HistoriaTestFramework):
    def set_test_params(self):
        ...
        self.set_historia_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_historia_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that historiad has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all historia related ZMQ publisher
