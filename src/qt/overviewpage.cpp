...
// Copyright (c) 2014-2021 The Historia Core developers
...
public:
    explicit TxViewDelegate(QObject* parent = nullptr) :
        QAbstractItemDelegate(), unit(BitcoinUnits::HISTORIA)
    {
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("HISTORIA")
        updateDisplayUnit();
