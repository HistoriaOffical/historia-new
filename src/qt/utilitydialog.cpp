    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:  historia-qt [command-line options]                     \n";
...
These denominations are 0.001 HISTORIA, 0.01 HISTORIA, 0.1 HISTORIA, 1 HISTORIA and 10 HISTORIA -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%2\" href=\"%3\">%1 documentation</a>."
        ...
        .arg("https://docs.historia.org/en/stable/wallets/historiacore/coinjoin-instantsend.html")
        );
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
