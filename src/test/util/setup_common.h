...
/* Initialize Historia-specific components after chainstate initialization */
void HistoriaTestSetup(NodeContext& node);
void HistoriaTestSetupClose(NodeContext& node);
