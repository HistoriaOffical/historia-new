...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire lohistoria.
    var _ = context && context._ || require('lohistoria') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of lohistoria methods to
     * make working with arrays, collections, and objects easier. The lohistoria
     * methods are:
     * [`each/forEach`](https://lohistoria.com/docs#forEach), [`forOwn`](https://lohistoria.com/docs#forOwn),
     * [`has`](https://lohistoria.com/docs#has), [`indexOf`](https://lohistoria.com/docs#indexOf),
     * [`map`](https://lohistoria.com/docs#map), and [`reduce`](https://lohistoria.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped lohistoria methods to
     * make working with Suites easier. The wrapped lohistoria methods are:
     * [`each/forEach`](https://lohistoria.com/docs#forEach), [`indexOf`](https://lohistoria.com/docs#indexOf),
     * [`map`](https://lohistoria.com/docs#map), and [`reduce`](https://lohistoria.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add lohistoria methods to Benchmark.
    ...
    // Add lohistoria methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['lohistoria', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
