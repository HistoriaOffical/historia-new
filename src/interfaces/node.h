...
//! Interface for the src/evo part of a historia node (historiad process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a historia node (historiad process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a historia node (historiad process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a historia node (historiad process).
...
//! Top-level interface for a historia node (historiad process).
class Node
{
public:
    virtual ~Node() {}
