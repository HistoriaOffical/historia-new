...
#ifndef HISTORIA_CRYPTO_BLS_H
#define HISTORIA_CRYPTO_BLS_H
...
// bls-historia uses relic, which may define DEBUG and ERROR, which leads to many warnings in some build setups
#undef ERROR
#undef DEBUG
#include <historiabls/bls.hpp>
#include <historiabls/privatekey.hpp>
#include <historiabls/elements.hpp>
#include <historiabls/schemes.hpp>
#include <historiabls/threshold.hpp>
#undef DOUBLE
#undef SEED
