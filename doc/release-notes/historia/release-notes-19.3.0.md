...
- `wipetxes`: New command for `historia-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/historia/historia/compare/v19.2.0...historia:v19.3.0).
