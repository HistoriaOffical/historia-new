Historia Core version 0.17.0.2
==========================
...
provided in [DIP-0020](https://github.com/historia/dips/blob/master/dip-0020.md).
...
from other quorum members. This allows Historia Platform to obtain required
...
provided in [DIP-0021](https://github.com/historia/dips/blob/master/dip-0021.md).

Platform support
----------------
Support for Historia Platform has been expanded through the addition of a new
...
BLS update
----------
Historia Core’s BLS signature library has been updated based on v1.0 of the
Chia BLS library to support migration to a new BLS signature scheme which will
be implemented in a future version of HistoriaCore. These changes will be made to
align with standards and improve security.

Network performance improvements
--------------------------------
This version of Historia Core includes multiple optimizations to the network and
p2p message handling code.

We reintroduced [Intra-Quorum Connections](https://github.com/historia/dips/blob/master/dip-0006.md#intra-quorum-communication)
...
reliability. Activation of `SPORK_22_PS_MORE_PARTICIPANTS` in HistoriaCore v0.16
...
Statoshi backport
------------------
This version includes a [backport](https://github.com/historia/historia/pull/2515)
...
RPC changes
-----------
There are seven new RPC commands which are Historia specific and seven new RPC
...
will be removed in HistoriaCore v0.18. Note that the deprecation of wallet accounts
...
Historia users. Bitcoin changes that do not align with Historia’s product needs, such
...
See detailed [set of changes](https://github.com/historia/historia/compare/v0.16.1.1...historia:v0.17.0.2).
