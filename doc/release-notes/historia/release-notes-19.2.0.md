...
At the first startup Historia Core will run a migration process which can take
...
incompatible with older versions of Historia Core, so a db migration path was
...
See detailed [set of changes](https://github.com/historia/historia/compare/v19.1.0...historia:v19.2.0).
