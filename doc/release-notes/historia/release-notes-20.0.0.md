...
Currently, 10% of block rewards are set aside for the Historia DAO treasury which
...
The asset lock process provides a mechanism for locking and unlocking Historia in a
credit pool. This credit pool mirrors the available credit supply in Historia
Platform. When a certain amount of Historia is locked, a proportional number of
credits are issued to the identity specified by the transaction issuer. The
identity then uses the credits to pay fees for operations done on Historia
Platform. Masternode identities receive the fees and can convert them back to
Historia by withdrawing them from Historia Platform.
...
### Removal of reject network messages from Historia Core (BIP61)

This feature has been disabled by default since Historia Core version 19.0.0.
Nodes on the network can not generally be trusted to send valid ("reject")
messages, so this should only ever be used when connected to a trusted node.

Since Historia Core version 20.0.0 there are extra changes:
...
- It is possible to run Historia Core as an I2P service and connect to such
...
- The `fundrawtransaction`, `sendmany`, `sendtoaddress`, and
  ...
  fee estimation methods, `HISTORIA/kB` and `duff/B`. The target is the fee
...
- `testmempoolaccept` and `sendrawtransaction` no longer return the P2P
  ...
  Section [_Removal of reject network messages from Historia Core (BIP61)_](#removal-of-reject-network-messages-from-historia-core-bip61) above for
...
### Historia-specific changes in existing RPCs:
...
- The `historia-cli -getinfo` command now displays the wallet name and balance for
...
Please check `Help -> Command-line options` in Qt wallet or `historiad --help` for
more information.
...
python test framework and `historia-cli` tool both take advantage of this, so
for example:

```sh
historia-cli -named createwallet wallet_name=mywallet load_on_startup=1
```

Can now be shortened to:

```sh
historia-cli -named createwallet mywallet load_on_startup=1
```
...
with Historia’s product needs, such as SegWit and RBF, are excluded from our
...
- [v19.3.0](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-19.3.0.md) released July/31/2023
- [v19.2.0](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-19.2.0.md) released June/19/2023
- [v19.1.0](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-19.1.0.md) released May/22/2023
- [v19.0.0](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-19.0.0.md) released Apr/14/2023
- [v18.2.2](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-18.2.2.md) released Mar/21/2023
- [v18.2.1](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-18.2.1.md) released Jan/17/2023
- [v18.2.0](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-18.2.0.md) released Jan/01/2023
- [v18.1.1](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-18.1.1.md) released January/08/2023
- [v18.1.0](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-18.1.0.md) released October/09/2022
- [v18.0.2](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-18.0.2.md) released October/09/2022
- [v18.0.1](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-18.0.1.md) released August/17/2022
- [v0.17.0.3](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-0.17.0.3.md) released June/07/2021
- [v0.17.0.2](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-0.17.0.2.md) released May/19/2021
- [v0.16.1.1](https://github.com/historia/historia/blob/master/doc/release-notes/historia/release-notes-0.16.1.1.md) released November/17/2020
...
[DIP-0023]: https://github.com/historia/dips/blob/master/dip-0023.md
[DIP-0029]: https://github.com/historia/dips/blob/master/dip-0029.md

[i2p]: https://github.com/historia/historia/blob/v20.x/doc/i2p.md
[guix-readme]: https://github.com/historia/historia/blob/v20.x/contrib/guix/README.md
[json-rpc]: https://github.com/historia/historia/blob/v20.x/doc/JSON-RPC-interface.md#parameter-passing
[set-of-changes]: https://github.com/historia/historia/compare/v19.3.0...historia:v20.0.0
