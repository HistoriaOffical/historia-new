...
- [`595826ad6`](https://github.com/historia/historia/commit/595826ad6) Merge #12549: Make prevector::resize() and other prevector operations much faster
...
- [`b451094e2`](https://github.com/historia/historia/commit/b451094e2) Merge #11490: Disconnect from outbound peers with bad headers chains
...
- [`6ec77c0a7`](https://github.com/historia/historia/commit/6ec77c0a7) Merge #11131: rpc: Write authcookie atomically
...
- [`17bb230d7`](https://github.com/historia/historia/commit/17bb230d7) Merge #11121: TestNode tidyups
...
- [`c438c9322`](https://github.com/historia/historia/commit/c438c9322) Merge #11022: Basic keypool topup
...
- [`40617436c`](https://github.com/historia/historia/commit/40617436c) Merge #10179: Give CValidationInterface Support for calling notifications on the CScheduler Thread
...
- [`746ebf165`](https://github.com/historia/historia/commit/746ebf165) fix indendation in wallet.cpp
...
- [`106fdfa0b`](https://github.com/historia/historia/commit/106fdfa0b) Fix tests
...
- [`2ada45284`](https://github.com/historia/historia/commit/2ada45284) Merge #10864: Avoid redundant redeclaration of GetWarnings(const string&)
...
- [`445e8d85c`](https://github.com/historia/historia/commit/445e8d85c) Merge #10807: getbalance example covers at least 6 confirms
...
- [`5ac5e66f3`](https://github.com/historia/historia/commit/5ac5e66f3) remove unneeded space wallet.cpp
...
- [`aa364bf7a`](https://github.com/historia/historia/commit/aa364bf7a) Merge #10555: [tests] various improvements to zmq_test.py
...
- [`b92d2dd66`](https://github.com/historia/historia/commit/b92d2dd66) Merge #10545: Use list initialization (C++11) for maps/vectors instead of boost::assign::map_list_of/list_of
...
- [`44a55019b`](https://github.com/historia/historia/commit/44a55019b) Merge #10478: rpc: Add listen address to incoming connections in `getpeerinfo`
...
- [`ea3afb995`](https://github.com/historia/historia/commit/ea3afb995) Merge #10433: [tests] improve tmpdir structure
...
- [`badfdb451`](https://github.com/historia/historia/commit/badfdb451) Fix rpc param names
...
- [`73a5d9bfd`](https://github.com/historia/historia/commit/73a5d9bfd) add `--quiet` to `test_runner.py`, replicates bitcoin#10105
...
- [`46db8eb68`](https://github.com/historia/historia/commit/46db8eb68) Merge #10168: Fix build warning from #error text
...
- [`b645757be`](https://github.com/historia/historia/commit/b645757be) Call RemoveConflictedTx from BlockConnected instead of ProcessNewTransaction
...
- [`c2258978b`](https://github.com/historia/historia/commit/c2258978b) Merge #10057: [init] Deduplicated sigaction() boilerplate
...
- [`0db1328a2`](https://github.com/historia/historia/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
...
- [`818ec218d`](https://github.com/historia/historia/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/historia/historia/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/historia/historia/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/historia/historia/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/historia/historia/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/historia/historia/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/historia/historia/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/historia/historia/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/historia/historia/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/historia/historia/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/historia/historia/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/historia/historia/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/historia/historia/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/historia/historia/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/historia/historia/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/historia/historia/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/historia/historia/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/historia/historia/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/historia/historia/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/historia/historia/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/historia/historia/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/historia/historia/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/historia/historia/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/historia/historia/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/historia/historia/commit/1cfda206a) Merge #9993: Initialize nRelockTime
