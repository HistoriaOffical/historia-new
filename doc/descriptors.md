# Support for Output Descriptors in Historia Core

Since Historia Core v0.17, there is support for Output Descriptors. This is a
...
existing Historia Core wallets, a convenience function `combo` is
...
All RPCs in Historia Core will include the checksum in their output. Only
